...
<div class="paira-container pages-container">
                    ...
                    <div class="pull-right col-md-3 col-sm-3 col-xs-4">
                        <div class="account-ajax-cart pull-right">
                            <ul class="list-inline pull-right">
                                ...
                                <li><a href="logout.php" class="login-popup"><img src="assets/images/corg.png" alt="" class=""> <?php echo  $_SESSION['email'];  ?></a></li>
    ...
    <main class="about-page">
        ...
        <section class="about-content paira-margin-bottom-3">
            <div class="container">
                <div class="row">
        ...
        <section class="about-team paira-margin-bottom-3 text-center">
            <div class="team-background">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 margin-bottom-10 heading-title">
                            <h2 class="text-capitalize margin-clear"><span>Meet our artist</span></h2>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-6 margin-top-30">
                            <div class="position-r">
                                <img src="assets/images/blog/about-team.png" alt="" class="img-responsive center-block">
                                <div class="team-title">
                                    <h4 class="margin-bottom-10">Devid Marlo</h4>
                                    <p>Artist</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-6 margin-top-30">
                            <div class="position-r">
                                <img src="assets/images/blog/about-team-1.png" alt="" class="img-responsive center-block">
                                <div class="team-title">
                                    <h4 class="margin-bottom-10">Devid Marlo</h4>
                                    <p>Artist</p>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6 margin-top-30">
                            <div class="position-r">
                                <img src="assets/images/blog/about-team-2.png" alt="" class="img-responsive center-block">
                                <div class="team-title">
                                    <h4 class="margin-bottom-10">Devid Marlo</h4>
                                    <p>Artist</p>
                                </div>
        ...
        <section class="about-team paira-margin-bottom-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 heading-title text-center">
                        <h2 class="text-capitalize margin-clear"><span>Mission & Vision</span></h2>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <ul class="list-unstyled margin-bottom-0 margin-top-30 lists">
                            <li>1. Cave putes quicquam esse verius.</li>
                            <li>2. Sed haec quidem liberius ab eo dicuntur et saepius.</li>
                            <li>3. Est autem officium, quod ita factum est, ut eius facti probabilis ratio reddi possit.</li>
                            <li>4. Huius, Lyco, oratione locuples, rebus ipsis ielunior.</li>
                            <li>5. Et ille ridens: Video, inquit, quid agas;</li>
                            <li>6. Inde sermone vario sex illa a Dipylo stadia confecimus.</li>
                            <li>7. Quae similitudo in genere etiam humano apparet.</li>
                            <li>8. Videamus animi partes, quarum est conspectus illustrior;</li>
                            <li>9. De hominibus dici non necesse est.</li>
                            <li>10. Is ita vivebat, ut nulla tam exquisita posset inveniri voluptas, qua non abundaret.</li>
                            <li>11. Summum ením bonum exposuit vacuitatem doloris;</li>
                            <li>12. Quis non odit sordidos, vanos, leves, futtiles?</li>
                        </ul>
                    </div>
                </div>
            </div>
