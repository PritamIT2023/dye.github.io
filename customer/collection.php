    ...
    <main class="search-page">
       ...
       <div class="row">
        ...
        <?php
            ...
            $query = "SELECT `id`, `title`, `image`, `detail`, `price` FROM  `art` order by id ASC";
         ...
         ?>
                     <section class="search-result latest-picture paira-margin-bottom-3">
                        <div class="search-content margin-top-30">
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-4 col-md-4 col-xs-12">
                                        <div class="product text-center">
                                            ...
                                            <div class="product-hover">
                                                <h3 class="margin-clear"><a href="collection.php"><?php echo $product['title']; ?></a></h3>
                                                <div class="text-center prices margin-top-15 margin-bottom-10">
                                                    <h4 class="pull-left margin-clear"><span class="money">$<?php echo $product['price']; ?></span></h4>
                                                </div>
                                                <p class="margin-bottom-15"><?php echo $product['detail']; ?></p>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row paira-margin-top-2">
                    <div class="col-md-4 pull-right padding-left-0 col-xs-12 col-sm-4 paira-success-message-img"><img src="assets/images/product/product-10.jpg" alt="" class="img-responsive"></div>
