...
<div class="paira-container pages-container">
    ...
    <main class="404-page">
            ...
            <div class="breadcrumb">
                <div class="container-fluid padding-fix">
                    <ul class="list-inline">
                        <li><a href="http://localhost/dye/customer/cu_index.php">Home <i class="fa fa-angle-right"></i></a></li>
                        <li>404</li>
                    </ul>
                </div>
            </div>
        ...
        <!--=================== 404 content Section ===================-->
        <section class="error-content paira-margin-bottom-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 heading-title">
                        <h2 class="text-capitalize margin-clear text-center"><span>Page Not Found</span></h2>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12 margin-top-30 text-center">
                        <div class="error">
                            <p class="margin-bottom-10">Portenta haec esse dicit, neque ea ratione ullo modo posse vivi; Cum sciret confestim esse moriendum eamque mortem eret, quam Epicurus voluptatem petendam putat. Eorum enim</p>
                            <h1 class="margin-clear">404</h1>
                            <h3 class="margin-clear">Your page is not found</h3>
                            <a href="cu_index.php" class="btn btn-lg btn-primary margin-top-20">Back To Home</a>
                        </div>
                    </div>
                </div>
            </div>
